                ...
                <>
                    <Card style={DXFParametersCardStyle}>
                        ...
                        <form style={{alignItems: "center"}}>
                            ...
                            <input type="text" id="fname" required={true} name="firstname"
                                   onChange={(e) => setName(e.target.value)} placeholder="John M. Doe"/>
                            <br/>
                            <label htmlFor="fname">Phone</label>
                            <input type="text" id="fname" required={true} name="firstname"
                                   onChange={(e) => setPhone(e.target.value)} placeholder="214123456"/>
                            <br/>
                            <label htmlFor="email"><i className="fa fa-envelope"></i> Email</label>
                            <input type="text" id="email" required={true} name="email"
                                   onChange={(e) => setEmail(e.target.value)} placeholder="john@example.com"/>
                            <br/>
                            <label htmlFor="adr"><i className="fa fa-address-card-o"></i> Address</label>
                            <input type="text" id="adr" required={true} name="address"
                                   onChange={(e) => setaddr(e.target.value)} placeholder="542 W. 15th Street"/>
                            <br/>
                            ...
                            <div className="row">
                                <div className="col-50">
                                    ...
                                    <input type="text" id="state" name="state" required={true}
                                           onChange={(e) => setState(e.target.value)} placeholder="NY"/>
                                    <br/>
