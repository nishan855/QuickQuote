...
public class FileController {
	...
	public String testUpload1(@RequestParam("file") MultipartFile uploadedFile[]) throws Exception {
		...
		System.out.println("All shapes: "+entityList.size());
		System.out.println("fragment shapes: "+shapes.size());
		System.out.println("Pierce Points: "+loops.size());
